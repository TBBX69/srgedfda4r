...
local Library = {
    Theme = {
    Accent = {
        Color3.fromHex("#ffb6c1"), -- light pink
        Color3.fromHex("#ffc0cb"), -- pastel pink
        Color3.fromHex("#dda0dd"), -- plum/lavender
        Color3.fromHex("#ff69b4"), -- hot pink accent
        Color3.fromHex("#e6b3ff")  -- soft lilac
    },
    Notification = {
        Error = Color3.fromHex("#ff4d6d"),   -- softer red
        Warning = Color3.fromHex("#ffb347")  -- peachy orange
    },
    Hitbox = Color3.fromHex("#ff99cc"),      -- pink overlay
    Friend = Color3.fromHex("#baffc9"),      -- mint green
    Outline = Color3.fromHex("#ffe6f0"),     -- off-white pink outline
    Inline = Color3.fromHex("#f2c2d4"),      -- rose pink inline
    LightContrast = Color3.fromHex("#ffe6f9"),
    DarkContrast = Color3.fromHex("#f0a6ca"),
    Text = Color3.fromHex("#fff0f5"),        -- lavender blush text
    TextInactive = Color3.fromHex("#d18cbc"),
