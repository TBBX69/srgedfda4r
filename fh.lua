...
library.themes = {
    {
        ...
        ["Background"]                = fromrgb(250, 245, 252); -- very light lavender
        ["Border"]                    = fromrgb(200, 160, 200); -- muted lilac border
        ["Border 1"]                  = fromrgb(210, 170, 210);
        ["Border 2"]                  = fromrgb(225, 190, 225);
        ["Border 3"]                  = fromrgb(235, 210, 235);
        ["Primary Text"]              = fromrgb(70, 50, 90); -- smooth lilac text
        ["Group Background"]          = fromrgb(255, 250, 255); -- nearly white pink
        ["Selected Tab Background"]   = fromrgb(245, 225, 240);
        ["Unselected Tab Background"] = fromrgb(235, 215, 230);
        ["Selected Tab Text"]         = fromrgb(255, 105, 180); -- hot pink
        ["Unselected Tab Text"]       = fromrgb(140, 110, 150); -- muted lilac
        ["Section Background"]        = fromrgb(250, 240, 250);
        ["Option Text 1"]             = fromrgb(80, 60, 100);
        ["Option Text 2"]             = fromrgb(110, 80, 130);
        ["Option Text 3"]             = fromrgb(150, 100, 160);
        ["Option Border 1"]           = fromrgb(220, 190, 220);
        ["Option Border 2"]           = fromrgb(200, 170, 200);
        ["Option Background"]         = fromrgb(255, 245, 250); -- soft pastel
        ["Risky Text"]                = fromrgb(200, 80, 120);
        ["Risky Text Enabled"]        = fromrgb(255, 20, 147); -- deep pink
        }
    }
}
