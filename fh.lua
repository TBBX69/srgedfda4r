...
library.themes = {
    {
        name = 'Default',
        theme = {
            ["Accent"]                    = fromrgb(255, 182, 193); -- pastel pink
        ["Background"]                = fromrgb(250, 240, 245); -- lavender blush
        ["Border"]                    = fromrgb(230, 200, 220);
        ["Border 1"]                  = fromrgb(240, 210, 230);
        ["Border 2"]                  = fromrgb(250, 225, 240);
        ["Border 3"]                  = fromrgb(220, 180, 210);
        ["Primary Text"]              = fromrgb(80, 50, 90); -- dark lilac text
        ["Group Background"]          = fromrgb(255, 245, 250); -- almost white pink
        ["Selected Tab Background"]   = fromrgb(255, 230, 240);
        ["Unselected Tab Background"] = fromrgb(245, 220, 235);
        ["Selected Tab Text"]         = fromrgb(255, 182, 193); -- pink highlight
        ["Unselected Tab Text"]       = fromrgb(170, 140, 160);
        ["Section Background"]        = fromrgb(255, 240, 245);
        ["Option Text 1"]             = fromrgb(90, 60, 100);
        ["Option Text 2"]             = fromrgb(120, 80, 140);
        ["Option Text 3"]             = fromrgb(160, 100, 180);
        ["Option Border 1"]           = fromrgb(230, 200, 225);
        ["Option Border 2"]           = fromrgb(210, 180, 210);
        ["Option Background"]         = fromrgb(255, 250, 255); -- soft baby pink
        ["Risky Text"]                = fromrgb(200, 100, 140);
        ["Risky Text Enabled"]        = fromrgb(255, 105, 180); -- hot pink
        }
    }
}
